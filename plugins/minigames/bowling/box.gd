...
func _physics_process(delta: float):
	...
	if collision != null and is_falling and multiplayer.is_network_server():
		is_falling = false
...
func knockout(_movement: Vector3):
	...
	# Prevent network race conditions with automatic node names generated by godot
	self.name = "destroyed_box"
	queue_free()
